...
describe("Expect PubKey to work correctly", () => {
  ...
  test("should be able to get hexString with 0x prefix", () =>
    expect(
      fromHex(
        "eb5ae9872103a54ffaa84c8f2f798782de8b962a84784e288487a747813a0857243a60e2ba33",
      )->toHex(~with0x=true),
  ...
  test("should be able to convert self to hex", () =>
    expect("AjW2GKsPDp9Isa8y9Wt42VXEMieYk3FHN6k3A1AkuDxY"->fromBase64)->toEqual(
      PubKey("0235b618ab0f0e9f48b1af32f56b78d955c432279893714737a937035024b83c58"),
    )
  )
  ...
  test("should be able to convert self to hex", () =>
    expect(
      PubKey("eb5ae9872103d03708f161d1583f49e4260a42b2b08d3ba186d7803a23cc3acd12f074d9d76f")->toHex,
  ...
  test("should be able to convert self to hex", () =>
    expect(
      PubKey(
        "eb5ae9872103d03708f161d1583f49e4260a42b2b08d3ba186d7803a23cc3acd12f074d9d76f",
      )->toPubKeyHexOnly,
  ...
  test("should be able to convert self to bech32", () =>
    ...
    )->toEqual("bandvalconspub1addwnpepq0grwz83v8g4s06fusnq5s4jkzxnhgvx67qr5g7v8tx39ur5m8tk7rg2nxj")
  )
