...
describe("Expect Decoder to work correctly", () => {
  ...
  test("hashFromHex", () =>
    expect({
      let json =
        `"1a4ef77bacf1634c08f1ab519c255f2abbf34742f18e91436b3d44190753ac51"`->Js.Json.parseExn
  ...
  test("intWithDefault default case", () =>
    expect({
  ...
  test("bufferWithDefault default case", () =>
    expect({
      let json = `null`->Js.Json.parseExn
  ...
  test("strWithDefault default case", () =>
    expect({
      let json = `null`->Js.Json.parseExn
  ...
  test("bufferFromHex", () =>
    expect({
      ...
      JsBuffer.fromHex("0x0235b618ab0f0e9f48b1af32f56b78d955c432279893714737a937035024b83c58="),
    )
  )
