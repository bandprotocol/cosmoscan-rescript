...
describe("Expect toString function to work correctly", () => {
  ...
  test("DataSourceDetailsPage Request", () => expect(DataSourceDetailsPage(123, DataSourceRequests)->toString)->toEqual("/data-source/123"))
  test("DataSourceDetailsPage Code", () => expect(DataSourceDetailsPage(123, DataSourceCode)->toString)->toEqual("/data-source/123#code"))
  test("DataSourceDetailsPage Execute", () => expect(DataSourceDetailsPage(123, DataSourceExecute)->toString)->toEqual("/data-source/123#execute"))

  test("OracleScriptPage", () => expect(OracleScriptPage->toString)->toEqual("/oracle-scripts"))
  test("OracleScriptDetailsPage Request", () => expect(OracleScriptDetailsPage(123, OracleScriptRequests)->toString)->toEqual("/oracle-script/123"))
  test("OracleScriptDetailsPage Code", () => expect(OracleScriptDetailsPage(123, OracleScriptCode)->toString)->toEqual("/oracle-script/123#code"))
  test("OracleScriptDetailsPage Bridge", () => expect(OracleScriptDetailsPage(123, OracleScriptBridgeCode)->toString)->toEqual("/oracle-script/123#bridge"))
  test("OracleScriptDetailsPage Execute", () => expect(OracleScriptDetailsPage(123, OracleScriptExecute)->toString)->toEqual("/oracle-script/123#execute"))

  test("TxHomePage", () => expect(TxHomePage->toString)->toEqual("/txs"))
  test("TxIndexPage", () => expect(
  ...
  test("RequestDetailsPage", () => expect(RequestDetailsPage(123)->toString)->toEqual("/request/123"))

  test("AccountIndexPage delegations", () => expect(
    AccountIndexPage(Address.fromBech32("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"), AccountDelegations)
    ->toString
  )->toEqual("/account/band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph#delegations"))

  test("AccountIndexPage unbonding", () => expect(
    AccountIndexPage(Address.fromBech32("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"), AccountUnbonding)
    ->toString
  )->toEqual("/account/band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph#unbonding"))

  test("AccountIndexPage redelegate", () => expect(
    AccountIndexPage(Address.fromBech32("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"), AccountRedelegate)
    ->toString
  )->toEqual("/account/band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph#redelegate"))

  test("ValidatorDetailsPage reports", () => expect(
    ValidatorDetailsPage(Address.fromBech32("band1ntwzz6tlvpy52tf5urr7jz6lvk2402sksntxuw"), Reports)
    ->toString
  )->toEqual("/validator/bandvaloper1ntwzz6tlvpy52tf5urr7jz6lvk2402sku909e9#reports"))

  test("ValidatorDetailsPage Delegators", () => expect(
    ValidatorDetailsPage(Address.fromBech32("band1ntwzz6tlvpy52tf5urr7jz6lvk2402sksntxuw"), Delegators)
    ->toString
  )->toEqual("/validator/bandvaloper1ntwzz6tlvpy52tf5urr7jz6lvk2402sku909e9#delegators"))

  test("ValidatorDetailsPage proposed-blocks", () => expect(
    ValidatorDetailsPage(Address.fromBech32("band1ntwzz6tlvpy52tf5urr7jz6lvk2402sksntxuw"), ProposedBlocks)
    ->toString
  ...
  test("ProposalDetailsPage", () => expect(ProposalDetailsPage(1)->toString)->toEqual("/proposal/1"))
  test("RelayersHomepage", () => expect(RelayersHomepage->toString)->toEqual("/relayers"))
  test("ChannelDetailsPage", () => expect(ChannelDetailsPage("beeb-terra","oracle","channel-97")->toString)->toEqual("/relayers/beeb-terra/oracle/channel-97"))
...
describe("Expect toAbsoluteString function to work correctly", () => {
  ...
  test("DataSourceDetailsPage", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("DataSourceDetailsPage NotFound", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("OracleScriptDetailsPage", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("OracleScriptDetailsPage code", () => expect({
    let url: RescriptReactRouter.url = {
      path: list{"oracle-script", "123"},
      hash: "code",
      search: "",
  ...
  test("OracleScriptDetailsPage bridge", () => expect({
    let url: RescriptReactRouter.url = {
      path: list{"oracle-script", "123"},
      hash: "bridge",
      search: "",
  ...
  test("OracleScriptDetailsPage execute", () => expect({
    let url: RescriptReactRouter.url = {
      path: list{"oracle-script", "123"},
      hash: "execute",
      search: "",
  ...
  test("OracleScriptDetailsPage revisions", () => expect({
    let url: RescriptReactRouter.url = {
      path: list{"oracle-script", "123"},
      hash: "revisions",
      search: "",
  ...
  test("BlockDetailsPage NotFound", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("RequestDetailsPage", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("RequestDetailsPage NotFound", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("AccountIndexPage", () => expect({
    ...
    url->fromUrl
  })->toEqual(AccountIndexPage(
    Address.fromBech32("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"), AccountDelegations)
  ))
  ...
  test("AccountIndexPage unbonding", () => expect({
    ...
    Address.fromBech32("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"), AccountUnbonding)
  ))
  ...
  test("AccountIndexPage redelegate", () => expect({
    ...
    Address.fromBech32("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"), AccountRedelegate)
  ))
  ...
  test("ValidatorDetailsPage", () => expect({
    let url: RescriptReactRouter.url = {
    ...
    url->fromUrl
  })->toEqual(ValidatorDetailsPage(
    Address.fromBech32("bandvaloper1p40yh3zkmhcv0ecqp3mcazy83sa57rgjde6wec"), Reports)
  ))
  ...
  test("ValidatorDetailsPage delegators", () => expect({
    ...
    Address.fromBech32("bandvaloper1p40yh3zkmhcv0ecqp3mcazy83sa57rgjde6wec"), Delegators)
  ))
  test("ValidatorDetailsPage reporters", () => expect({
    let url: RescriptReactRouter.url = {
      path: list{"validator", "bandvaloper1p40yh3zkmhcv0ecqp3mcazy83sa57rgjde6wec"},
      hash: "reporters",
      search: "",
    ...
    Address.fromBech32("bandvaloper1p40yh3zkmhcv0ecqp3mcazy83sa57rgjde6wec"), Reporters)
  ))
  ...
  test("ValidatorDetailsPage proposed-blocks", () => expect({
    ...
    Address.fromBech32("bandvaloper1p40yh3zkmhcv0ecqp3mcazy83sa57rgjde6wec"), ProposedBlocks)
  ))

  test("ValidatorDetailsPage NotFound", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("ProposalDetailsPage", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("ProposalDetailsPage NotFound", () => expect({
    let url: RescriptReactRouter.url = {
  ...
  test("ChannelDetailsPage", () => expect({
    let url: RescriptReactRouter.url = {
