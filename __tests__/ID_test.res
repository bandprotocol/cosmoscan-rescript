...
describe("Expect IDCreator Module to works correctly", () => {
  ...
  test("getRoute", () => expect(testMockID->TestMock.getRoute)->toEqual(HomePage))

  test("getRouteWithTab", () => expect(testMockID->TestMock.getRouteWithTab())->toEqual(HomePage))
  ...
  test("Expect fromJson to throw Exception", () =>
    expect({
  ...
  test("Expect fromIntExn to throw Exception", () =>
    expect(() => None->TestMock.fromIntExn)->toThrow
  )
...
describe("Expect DataSource Module to works correctly", () => {
  ...
  test("route", () =>
    expect(DataSource.route(236, Route.DataSourceCode))->toEqual(
      Route.DataSourceDetailsPage(236, Route.DataSourceCode),
    )
  )

  test("getRoute", () =>
    expect(dataSourceID->DataSource.getRoute)->toEqual(
      DataSourceDetailsPage(236, Route.DataSourceRequests),
    )
  )

  test("getRouteWithTab", () =>
    expect(dataSourceID->DataSource.getRouteWithTab(Route.DataSourceExecute))->toEqual(
      DataSourceDetailsPage(236, Route.DataSourceExecute),
    )
  )
  ...
  test("Expect fromIntExn to throw Exception", () =>
    expect(() => None->DataSource.fromIntExn)->toThrow
  )
...
describe("Expect OracleScript Module to works correctly", () => {
  ...
  test("route", () =>
    expect(OracleScript.route(111, Route.OracleScriptCode))->toEqual(
      Route.OracleScriptDetailsPage(111, Route.OracleScriptCode),
    )
  )

  test("getRoute", () =>
    expect(oracleScriptID->OracleScript.getRoute)->toEqual(
      OracleScriptDetailsPage(111, Route.OracleScriptRequests),
    )
  )

  test("getRouteWithTab", () =>
    expect(oracleScriptID->OracleScript.getRouteWithTab(Route.OracleScriptExecute))->toEqual(
      OracleScriptDetailsPage(111, Route.OracleScriptExecute),
    )
  )
  ...
  test("Expect fromIntExn to throw Exception", () =>
    expect(() => None->OracleScript.fromIntExn)->toThrow
  )
...
describe("Expect Request Module to works correctly", () => {
  ...
  test("route", () => expect(Request.route(12345, ()))->toEqual(Route.RequestDetailsPage(12345)))

  test("getRoute", () => expect(requestID->Request.getRoute)->toEqual(RequestDetailsPage(12345)))

  test("getRouteWithTab", () =>
    expect(requestID->Request.getRouteWithTab())->toEqual(RequestDetailsPage(12345))
  )
  ...
  test("Expect fromIntExn to throw Exception", () =>
    expect(() => None->Request.fromIntExn)->toThrow
  )
...
describe("Expect Proposal Module to works correctly", () => {
  ...
  test("route", () => expect(Proposal.route(5, ()))->toEqual(Route.ProposalDetailsPage(5)))

  test("getRoute", () => expect(proposalID->Proposal.getRoute)->toEqual(ProposalDetailsPage(5)))

  test("getRouteWithTab", () =>
    expect(proposalID->Proposal.getRouteWithTab())->toEqual(ProposalDetailsPage(5))
  )
  ...
  test("Expect fromIntExn to throw Exception", () =>
    expect(() => None->Proposal.fromIntExn)->toThrow
  )
...
describe("Expect Block Module to works correctly", () => {
  ...
  test("route", () => expect(Block.route(123456, ()))->toEqual(Route.BlockDetailsPage(123456)))

  test("getRoute", () => expect(blockID->Block.getRoute)->toEqual(BlockDetailsPage(123456)))

  test("getRouteWithTab", () =>
    expect(blockID->Block.getRouteWithTab())->toEqual(BlockDetailsPage(123456))
  )
