...
describe("Expect Hash Module to work correctly", () => {
  ...
  test("parse", () =>
    expect({
      let json =
        `"0x28913c89fa628136fffce7ded99d65a4e3f5c211f82639fed4adca30d53b8dff"`->Js.Json.parseExn
...
describe("Expect AddressOpt Module to work correctly", () => {
  ...
  test("parse", () =>
    expect(Some("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph")->parse)->toEqual(
      Some("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"->Address.fromBech32),
    )
  )
...
describe("Expect Address Module to work correctly", () => {
  ...
  test("parse", () =>
    expect("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"->parse)->toEqual(
  ...
  test("serialize", () =>
    expect("band18p27yl962l8283ct7srr5l3g7ydazj07dqrwph"->Address.fromBech32->serialize)->toEqual(
...
describe("Expect Coins Module to work correctly", () => {
  ...
  test("parse", () =>
    expect("1000uband,3000uband"->parse)->toEqual(list{
      Coin.newCoin("uband", 1000.),
      Coin.newCoin("uband", 3000.),
    })
  )

  test("serialize", () =>
    expect(list{Coin.newCoin("uband", 1000.), Coin.newCoin("uband", 3000.)}->serialize)->toEqual(
      "1000uband, 3000uband",
    )
  )
})
...
describe("Expect CoinWithDefault Module to work correctly", () => {
  ...
  test("serialize", () =>
    expect(Coin.newCoin("uband", 3000.)->serialize)->toEqual(Some("3000uband"->Js.Json.string))
  )
})
...
describe("Expect Coin Module to work correctly", () => {
  ...
  test("serialize", () =>
    expect(Coin.newCoin("uband", 3000.)->serialize)->toEqual("3000uband"->Js.Json.string)
  )
})
...
describe("Expect Buffer Module to work correctly", () => {
  ...
  test("parse", () =>
    expect({
      ...
      "0235b618ab0f0e9f48b1af32f56b78d955c432279893714737a937035024b83c58"->JsBuffer.fromHex,
    )
  )
  ...
  test("serialize", () =>
    expect({
      ...
      "0x0235b618ab0f0e9f48b1af32f56b78d955c432279893714737a937035024b83c58"->Js.Json.string,
    )
  )
})
...
describe("Expect BufferOpt Module to work correctly", () => {
  ...
  test("parse", () =>
    expect({
      ...
      Some("0235b618ab0f0e9f48b1af32f56b78d955c432279893714737a937035024b83c58"->JsBuffer.fromHex),
    )
  )
  ...
  test("serialize", () =>
    expect({
      ...
      Some("0x0235b618ab0f0e9f48b1af32f56b78d955c432279893714737a937035024b83c58"->Js.Json.string),
    )
  )
