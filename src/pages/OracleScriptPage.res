  ...
  <Section>
    <div className=CssHelper.container id="oraclescriptsSection">
      <div className=CssHelper.mobileSpacing>
        ...
        | Data(oracleScripts) if oracleScripts->Belt.Array.length === 0 => React.null
        | Data(oracleScripts) =>
          <>
            <Heading
              value="Most Requested" size=Heading.H3 marginBottom=16 color={theme.textSecondary}
            />
            <Row>
              {oracleScripts
        ...
        <Table>
          ...
          {switch allSub {
          | Data((oracleScripts, _)) if oracleScripts->Belt.Array.length === 0 =>
            <EmptyContainer>
              <img
