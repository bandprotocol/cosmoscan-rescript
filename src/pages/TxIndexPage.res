      ...
      <div className=CssHelper.container>
        ...
        <div className={Styles.notfoundContainer(theme)}>
          <div className={CssHelper.flexBox()}>
            <img
              src={isDarkMode ? Images.noTxDark : Images.noTxLight} className=Styles.notfoundLogo
            />
          </div>
    ...
    <Section>
      <div className=CssHelper.container>
        <Row marginBottom=40 marginBottomSm=16>
          <Col>
            <Heading value="Transaction Details" size=Heading.H2 marginBottom=32 marginBottomSm=8 />
            <div className={CssHelper.flexBox()}>
              {switch txSub {
              | Data(_) =>
                isMobile
