  ...
  let make = (~validator: MsgDecoder.CreateValidator.t) => {
    ...
    <Row>
      ...
      <Col col=Col.Six mb=24>
        ...
        />
        <AddressRender
          position=AddressRender.Subtitle address=validator.validatorAddress accountType=#validator
        />
      </Col>
      <Col mb=24>
        <Heading
...
module EditValidatorMsg = {
  @react.component
  let make = (~validator: MsgDecoder.EditValidator.t) => {
    let ({ThemeContext.theme: theme}, _) = React.useContext(ThemeContext.context)
    <Row>
      <Col col=Col.Six mb=24>
        <Heading
      ...
      <Col col=Col.Six mb=24>
        ...
        />
        <AddressRender
          position=AddressRender.Subtitle address=validator.sender accountType=#validator
        />
      </Col>
      <Col mb=24>
        <Heading
  ...
  let make = (~unjail: MsgDecoder.Unjail.t) => {
    ...
    <Row>
      <Col col=Col.Six>
        ...
        />
        <AddressRender
          position=AddressRender.Subtitle address=unjail.address accountType=#validator
        />
      </Col>
    </Row>
  }
  ...
  let make = (~address: MsgDecoder.AddReporter.success_t) => {
    ...
    <Row>
      <Col col=Col.Six mbSm=24>
        ...
        />
        <AddressRender
          position=AddressRender.Subtitle address=address.validator accountType=#validator
        />
      </Col>
      <Col col=Col.Six>
        <Heading
  ...
  let make = (~activate: MsgDecoder.Activate.t) => {
    ...
    <Row>
      <Col col=Col.Six>
        ...
        />
        <AddressRender
          position=AddressRender.Subtitle address=activate.validatorAddress accountType=#validator
        />
      </Col>
    </Row>
  }
  ...
  let make = (~set: MsgDecoder.SetWithdrawAddress.t) => {
    ...
    <Row>
      <Col col=Col.Six mbSm=24>
        ...
        />
        <AddressRender
          position=AddressRender.Subtitle address=set.delegatorAddress accountType=#validator
        />
      </Col>
      <Col col=Col.Six>
        <Heading
