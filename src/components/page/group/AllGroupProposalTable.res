              ...
              <div className={Css.merge(list{"table-wrapper", Styles.tableHeadWrapper(theme)})}>
                {isMobile
                  ...
                  : <div className={Css.merge(list{Styles.tablehead})}>
                      <div>
                        <SortableTHead
                          title="Proposal ID" direction toggle value=SortGroupTable.ID sortedBy
                        />
                      </div>
                      <div>
                        <SortableTHead
                          title="Proposal Name" direction toggle sortedBy value=SortGroupTable.Name
                        />
                      </div>
                      <div>
                        <SortableTHead
                          ...
                          sortedBy
                          direction
                          value=SortGroupTable.MembersCount
                        />
                      </div>
                      <div>
                        <SortableTHead
