...
module Group = ComponentCreator(ID.Group)
module GroupProposal = ComponentCreator(ID.GroupProposal)
...
module GroupLink = PlainLinkCreator(ID.Group)
module GroupProposalLink = PlainLinkCreator(ID.GroupProposal)
