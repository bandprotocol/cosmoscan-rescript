                         ...
                         | Some(encoded) =>
                           ...
                           dispatch(
                              AccountContext.SendRequest({
                                  ...
                                  feeLimit: feeLimit->Belt.Int.fromString->Belt.Option.getExn,
                                  prepareGas: feeLimit->Belt.Int.fromString->Belt.Option.getExn,
                                  executeGas: feeLimit->Belt.Int.fromString->Belt.Option.getExn,
                              }),
                           );
                           ();
                         | None =>
